...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from an F distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	constructor( d1: number, d2: number, options?: Options );
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating F distributed pseudorandom numbers.
	*/
...
interface Constructor {
	...
	* stream.pipe( inspectStream( log )  );
	*/
	new( d1: number, d2: number, options?: Options ): RandomStream; // newable
	...
	* stream.pipe( inspectStream( log )  );
	*/
	( d1: number, d2: number, options?: Options ): RandomStream; // callable
	...
	*/
	objectMode( d1: number, d2: number, options?: Options ): RandomStream;
}
